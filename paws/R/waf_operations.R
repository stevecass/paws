...
#' `IPSetId` is returned by [`create_ip_set`][waf_create_ip_set] and by
...
#' is returned by [`create_rule`][waf_create_rule] and by
...
#' `WebACLId` is returned by [`create_web_acl`][waf_create_web_acl] and by
...
#' is returned by [`create_ip_set`][waf_create_ip_set] and by
#' [`list_ip_sets`][waf_list_ip_sets].
#'
#' @return
#' A list with the following syntax:
...
#' [`get_rate_based_rule`][waf_get_rate_based_rule] request.
#'
#' @usage
...
#' included in the [`get_rule`][waf_get_rule] request.
#'
#' @usage
#' waf_get_rule(RuleId)
#'
#' @param RuleId &#91;required&#93; The `RuleId` of the <span>Rule</span> that you want to get. `RuleId` is
#' returned by [`create_rule`][waf_create_rule] and by
#' [`list_rules`][waf_list_rules].
#'
#' @return
#' A list with the following syntax:
...
#' [`get_rule_group`][waf_get_rule_group] request.
#' 
