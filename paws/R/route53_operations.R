...
#' <span>https://console.aws.amazon.com/trustedadvisor/</span>. Then choose
...
#' United States. For a list of state abbreviations, see <span>Appendix B:
#' Two–Letter State and Possession Abbreviations</span> on the United
