...
#'     account limits for the organization, contact <span>AWS
#'     Support</span>.
#' 
...
#'     then try again. If the error persists, contact <span>AWS
#'     Support</span>.
#' 
...
#' invitation is implemented as a <span>Handshake</span> whose details are
#' in the response.
#' 
